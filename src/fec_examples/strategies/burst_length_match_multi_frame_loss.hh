...
#ifndef STRATEGY_BURST_LENGTH_MATCH_MULTI_FRAME_LOSS_HH
#define STRATEGY_BURST_LENGTH_MATCH_MULTI_FRAME_LOSS_HH

class BurstLengthMatchMultiFrameLoss : public GEStrategy
{
public:
    BurstLengthMatchMultiFrameLoss(uint16_t tau, const char* trace_file) : GEStrategy(tau, trace_file) {
        setLossGoodState();
        setLossBadState();
