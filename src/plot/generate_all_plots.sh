...
python3 $SCRIPT_DIR/cdf_non_recoverable_frames.py --log $LOG --config $CONFIG --output $PLOT/cdf_recoverable_frames.svg
python3 $SCRIPT_DIR/decode_latency_end_to_end.py --log $LOG --config $CONFIG --output $PLOT/cdf_decode_latency_end_to_end.svg
python3 $SCRIPT_DIR/cdf_bandwidth_overhead.py --log $LOG --config $CONFIG --output $PLOT/cdf_bandwidth_overhead.svg
...
python3 $SCRIPT_DIR/decode_latency_frames.py --log $LOG --config $CONFIG --output $PLOT/bar_decode_latency_frames.svg --max_frames 3
...
python3 $SCRIPT_DIR/freeze.py --log $LOG --config $CONFIG --output $PLOT/freeze.svg